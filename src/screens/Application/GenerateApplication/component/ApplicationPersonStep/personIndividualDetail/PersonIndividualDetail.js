...
import {
    changePersonType, getApplicationPersonDataFromABNOrACN,
    removePersonDetail,
...
const PersonIndividualDetail = ({ itemHeader, index, entityTypeFromCompany ,companyEntityType,
                                    streetType,
                                    australianStates,
                                    countryList,
                                    newZealandStates}) => {
                ...
                try {
                    if (e.key === 'Enter') {
                        const response = await dispatch(
                                getApplicationPersonDataFromABNOrACN(e.target.value)
                        );
