            ...
            Are you sure you want to delete this document?
                ...
                <table className="documents-table">
                    ...
                    documentData?.map(document => (
                            <tr>
                                <td><Tooltip overlayClassName="tooltip-top-class" overlay={<span>{document.documentTypeId || 'No value'}</span>} placement="top"><span>{document.documentTypeId}</span></Tooltip></td>
                                <td><Tooltip overlayClassName="tooltip-top-class" overlay={<span>{document.description || 'No value'}</span>} placement="top"><span>{document.description}</span></Tooltip></td>
                                <td align="right">
                  <span
