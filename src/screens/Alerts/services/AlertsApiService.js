...
export const AlertsApiService = {
  ...
  getAlertsColumnList: params =>
    ApiService.getData(ALERTS_URLS.GET_ALERTS_COLUMN_LIST, { params }),
  updateAlertsColumnList: data =>
    ApiService.putData(ALERTS_URLS.UPDATE_ALERTS_COLUMN_LIST, data),
