...
const EmployeeApiService = {
    ...
    getEmployeeColumnList: params => ApiService.getData(EMPLOYEE_URLS.EMPLOYEE_COLUMN_LIST, {params}),
    updateEmployeeUpdateColumnList: data => ApiService.putData(EMPLOYEE_URLS.EMPLOYEE_COLUMN_LIST, data)
}
